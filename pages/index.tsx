                  ...
                  <>
                    ...
                    <div className="space-y-8 dark:text-white flex flex-col items-center justify-center max-w-xl mx-auto">
                      <div
                        ...
                        <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Check out my summary from SiteExplainer.com 🔥`)}&url=${encodeURIComponent(`https://www.siteexplainer.com`)}&hashtags=${encodeURIComponent(`SiteExplainer`)}}&amp;image=${encodeURIComponent(`https://textoverimage.moesif.com/image?image_url=https%3A%2F%2Fi.imgur.com%2FmDhdcXm.png&text=${encodeURIComponent(generatedSummary.toString())}&text_color=e4e1f1ff&text_size=32&margin=160&y_align=middle&x_align=center`)}`}
